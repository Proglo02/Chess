...
public class Queen extends Piece{
    ...
    private static boolean isEightColumnExclusion(final int currentPosition, final int candidateOfset){
        return BoardUtils.EIGHT_COLUMN[currentPosition] && (candidateOfset == -7 ||candidateOfset == 1 || candidateOfset == 9);
    }
}
